...
| cluster.monitoring.instrumentation.logicalReplication | bool | `true` | Enable logical_replication PostgreSQL metrics |
| cluster.monitoring.instrumentation.paradedb | bool | `true` | Enable ParadeDB Index metrics |
...
| version.paradedb | string | `"0.18.0"` | We default to v0.18.0 for testing and local development |
