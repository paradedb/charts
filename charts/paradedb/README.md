...
The ParadeDB Helm Chart supports Postgres 14+ and ships with Postgres 18 by default.
...
| version.paradedb | string | `"0.21.2"` | We default to v0.21.2 for testing and local development |
